            ...
            foreach (var doc in documents)
{
    if (doc.ScannerGrid != null)
    {
        ...
        private void AttachEvents()
        {
            ...
            localizationMenu.DropDownItems.Add("–ÛÒÒÍËÈ", null, (s, e) => SetLanguage("ru"));
            ...
            HighlightAll¬ÒÂToolStripMenuItem.Click += SelectAllText;
        ...
        private DataGridView CreateScannerGrid()
        {
            ...
            grid.Columns.Add("Message", "—ÓÓ·˘ÂÌËÂ");
            grid.Columns.Add("Position", "œÓÁËˆËˇ");
        ...
        private void RunAnalysis(object sender, EventArgs e)
        {
            if (currentDocument == null)
            {
                MessageBox.Show("ÕÂÚ ‰ÓÍÛÏÂÌÚ‡", "Œ¯Ë·Í‡", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void UpdateResultTabIndicator(int errorCount)
        {
            ...
            {
                tabPageResults.ImageIndex = 0;
                tabPageResults.Text = $"{Strings.Result} ó {Strings.Nomistakes}";
            }
            else
            {
                ...
                tabPageResults.Text = $"{Strings.Result} ó {errorCount} {word}";
            }
        }
        ...
        private void FillSemanticErrors(SemanticResult result)
        {
            ...
            foreach (var err in result.Errors)
            {
                grid.Rows.Add(
                    err.Message,
                    $"ÒÚÓÍ‡ {err.Line}, ÒËÏ‚ÓÎ {err.StartColumn}"
                );
            }
        ...
        private void ShowAstMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("—Ì‡˜‡Î‡ ‚˚ÔÓÎÌËÚÂ ‡Ì‡ÎËÁ (F5).", "AST", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
